...
htmlhelp_basename = 'stelardataprofilerdoc'
...
man_pages = [
    (master_doc, 'stelardataprofiler', 'stelardataprofiler Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'stelardataprofiler', 'stelardataprofiler Documentation',
     author, 'stelardataprofiler', 'One line description of project.',
     'Miscellaneous'),
]
